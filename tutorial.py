...
alienimage=pygame.image.load('data/ennemi.png')
...
#gestion taille boutons (largeur + taille caracteres(size) en fonction du message)
#gestion du cliquage sur le boutton ou non 
            ...
            while loop:
                ...
                for event in pygame.event.get():
                    if event.type==pygame.MOUSEBUTTONUP:
                        e=True
                if e:
                    return True # le retour true ou false va permettre de savoir si les boutons soit 1,2,3 etc sont vrai ou pas dans la fonction menu du fichier menu
...
def drawfirst(win):
    ...
    drawtutorialship(win,390,350)#representation vaisseau bas page tutorial

    printKey(win,'A',330,360)# bouton fixe 'A','D' etc... bas ecran tutorial
...
def drawsecond(win):
    ...
    drawtutorialship(win,390,400)#representation vaisseau bas page tutorial
    win.blit(alienimage,(390,220))#affichage alien en haut page tutorial , varaible declaré en haut de ce fichier

    drawLaser(win,444,340,yellow)#affichage des lasers jaunes et vert 2 eme page tutorial 
...
def doTutorial(win):
    #variable first,second,...,fifth declare en debut de fichier tutorial
    #first est declare True , tous les autres False
    global first
    global second
    global third
    global fourth
